 ...
 *  @file   GNSSFactor.h
 *  @author Felix Esser
 *  @brief  Header file for GNSS factor
 *  @date   April 11, 2023
 **/
 ...
 */
class GTSAM_EXPORT GNSSFactor: public NoiseModelFactor1<Pose3> {
...
private:
  ...
  Eigen::Vector3d sTb_; ///< GPS Leverarm
...
public:
  ...
  GNSSFactor(): nT_(0, 0, 0), sTb_(0, 0, 0){}
   ...
   */
  GNSSFactor(Key key, const Point3& gpsIn, const SharedNoiseModel& model, const Eigen::Vector3d& leverarm) :
